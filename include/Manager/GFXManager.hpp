...
class GFXManager
{
    ...
    public:
        ...
        static void DrawTexture(std::string Texture, SDL_FRect* RenderSquare, Camera* Camera = nullptr, SDL_Rect* clip = nullptr, double angle = 0.0, SDL_FPoint* center = nullptr, SDL_RendererFlip flipMode = SDL_FLIP_NONE);
